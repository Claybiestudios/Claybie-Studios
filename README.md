...
</div><div class="price">Total: $<span id="totalPrice">46.69</span></div>
<button type="button" onclick="validatePage2()">Next</button>  </div>  <div class="container hidden" id="page3">
    <div class="question">
    ...
    let basePrice = 46.69;function goToPage(num) {
